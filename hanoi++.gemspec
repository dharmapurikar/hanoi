Gem::Specification.new do |s|
  ...
  s.version            = "0.0.1.1"
  s.date               = "2009-09-11"
  s.summary            = "Automated jQuery tests with QUnit with additional features"
  s.author             = "Sachin Dharmapurikar"
  s.email              = "hanoi@dharmapurikar.in"
  s.description        = "Automated jQuery tests with QUnit with additional features"
  s.has_rdoc           = true
  s.executables        = [ 'hanoi++' ]
